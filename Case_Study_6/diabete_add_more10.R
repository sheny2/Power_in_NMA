...
diabetes_ab_56 = rbind(diabetes_ab_56, c(28, "5", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_e)) )
diabetes_ab_56 = rbind(diabetes_ab_56, c(28, "6", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_f)) )
diabetes_ab_56 = rbind(diabetes_ab_56, c(29, "5", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_e)) )
diabetes_ab_56 = rbind(diabetes_ab_56, c(29, "6", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_f)) )
diabetes_ab_56 = rbind(diabetes_ab_56, c(30, "5", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_e)) )
diabetes_ab_56 = rbind(diabetes_ab_56, c(30, "6", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_f)) )
diabetes_ab_56 = rbind(diabetes_ab_56, c(31, "5", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_e)) )
diabetes_ab_56 = rbind(diabetes_ab_56, c(31, "6", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_f)) )
diabetes_ab_56 = rbind(diabetes_ab_56, c(32, "5", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_e)) )
diabetes_ab_56 = rbind(diabetes_ab_56, c(32, "6", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_f)) )
...
save(result_diabetes, file = "result_diabetes_4power_add56ten.RData")
...
diabetes_ab_23 = rbind(diabetes_ab_23, c(28, "2", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_b)) )
diabetes_ab_23 = rbind(diabetes_ab_23, c(28, "3", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_c)) )
diabetes_ab_23 = rbind(diabetes_ab_23, c(29, "2", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_b)) )
diabetes_ab_23 = rbind(diabetes_ab_23, c(29, "3", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_c)) )
diabetes_ab_23 = rbind(diabetes_ab_23, c(30, "2", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_b)) )
diabetes_ab_23 = rbind(diabetes_ab_23, c(30, "3", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_c)) )
diabetes_ab_23 = rbind(diabetes_ab_23, c(31, "2", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_b)) )
diabetes_ab_23 = rbind(diabetes_ab_23, c(31, "3", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_c)) )
diabetes_ab_23 = rbind(diabetes_ab_23, c(32, "2", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_b)) )
diabetes_ab_23 = rbind(diabetes_ab_23, c(32, "3", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_c)) )
...
save(result_diabetes, file = "result_diabetes_4power_add23ten.RData")
...
diabetes_ab_14 = rbind(diabetes_ab_14, c(28, "1", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_a)) )
diabetes_ab_14 = rbind(diabetes_ab_14, c(28, "4", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_d)) )
diabetes_ab_14 = rbind(diabetes_ab_14, c(29, "1", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_a)) )
diabetes_ab_14 = rbind(diabetes_ab_14, c(29, "4", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_d)) )
diabetes_ab_14 = rbind(diabetes_ab_14, c(30, "1", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_a)) )
diabetes_ab_14 = rbind(diabetes_ab_14, c(30, "4", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_d)) )
diabetes_ab_14 = rbind(diabetes_ab_14, c(31, "1", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_a)) )
diabetes_ab_14 = rbind(diabetes_ab_14, c(31, "4", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_d)) )
diabetes_ab_14 = rbind(diabetes_ab_14, c(32, "1", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_a)) )
diabetes_ab_14 = rbind(diabetes_ab_14, c(32, "4", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_d)) )
...
save(result_diabetes, file = "result_diabetes_4power_add14ten.RData")
...
diabetes_ab_34 = rbind(diabetes_ab_34, c(28, "3", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_c)) )
diabetes_ab_34 = rbind(diabetes_ab_34, c(28, "4", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_d)) )
diabetes_ab_34 = rbind(diabetes_ab_34, c(29, "3", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_c)) )
diabetes_ab_34 = rbind(diabetes_ab_34, c(29, "4", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_d)) )
diabetes_ab_34 = rbind(diabetes_ab_34, c(30, "3", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_c)) )
diabetes_ab_34 = rbind(diabetes_ab_34, c(30, "4", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_d)) )
diabetes_ab_34 = rbind(diabetes_ab_34, c(31, "3", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_c)) )
diabetes_ab_34 = rbind(diabetes_ab_34, c(31, "4", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_d)) )
diabetes_ab_34 = rbind(diabetes_ab_34, c(32, "3", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_c)) )
diabetes_ab_34 = rbind(diabetes_ab_34, c(32, "4", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_d)) )
...
save(result_diabetes, file = "result_diabetes_4power_add34ten.RData")
stopCluster(cl)
