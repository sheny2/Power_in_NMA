...
save(result_diabetes, file = "result_diabetes_4power_add56one.RData")
...
save(result_diabetes, file = "result_diabetes_4power_add23one.RData")
...
result_diabetes = matrix(result_diabetes, nrow = 1)
colnames(result_diabetes) <- c("Power.5-6","Power.2-3","Power.1-4","Power.3-4")
save(result_diabetes, file = "result_diabetes_4power_add14one.RData")
...
save(result_diabetes, file = "result_diabetes_4power_add34one.RData")
stopCluster(cl)
