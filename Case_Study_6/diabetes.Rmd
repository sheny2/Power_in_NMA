...
diabetes_p1 = result_diabetes_all %>%
  mutate(Modification = factor(
    Modification,
    levels = c( "Original", "Add 5-6 study", "Add 2-3 study", "Add 1-4 study", "Add 3-4 study")
  )) %>%
...
library(gridExtra)
grid.arrange(arrangeGrob(diabetes_p1 + theme(legend.position="none") + labs(title = "Add one more study"),
                         diabetes_p5 + theme(legend.position="none") + labs(title = "Add five more studies"),
                         diabetes_p10 + theme(legend.position="none") + labs(title = "Add ten more studies"), nrow = 1),
             lemon::g_legend(diabetes_p1 +  theme(legend.position="bottom") + guides(colour = guide_legend(nrow = 1))),
