...
power.sim.NMA <- function(S = 3, k_ab = 0, k_ac = 0, k_bc = 0, pi_a = 0.5, OR_ab = 1.2, OR_ac = 1.4, tau = 0.01){
...
# power.sim.NMA(k_ab = 2, k_ac = 2, k_bc = 2, pi_a = 0.1, OR_ab = 1.2, OR_ac = 1.4, tau = 0.1)