...
grid.arrange(
  arrangeGrob(
    simple_1 + theme(legend.position = "none") + labs(title = "(a) Power of Closed Loop vs. Direct Evidence only vs. Indirect Evidence only"),
    simple_2 + theme(legend.position = "none") + labs(title = "(b) Bias of Closed Loop vs. Direct Evidence only vs. Indirect Evidence only")
  ),
  lemon::g_legend(
    simple_1 
