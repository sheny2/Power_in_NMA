...
cons.model <- mtc.model(parkinson_net, type="consistency", 
                        likelihood="normal", link="identity", linearModel="random", hy.prior=mtc.hy.prior("std.dev", "dunif", 0.01, 10))
...
# t = as.integer(factor(parkinson_ab$treatment, levels = c("A", "B", "C", "D"), labels = c(1, 2, 3, 4)))
y = parkinson_ab$mean
sigma = parkinson_ab$std.dev
n = parkinson_ab$sampleSize
# drug_list<-unique(parkinson_ab$treatment)
