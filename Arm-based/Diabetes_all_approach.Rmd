...
summary(relative.effect(cons.out, "1"))
gemtc::forest(relative.effect(cons.out, "1"))

gemtc_trt_results = cbind(mean = summary(relative.effect(cons.out, "1"))$summaries$statistics[1:5,1], 
                        summary(relative.effect(cons.out, "1"))$summaries$quantiles[1:5,c(1,5)]) %>% as.data.frame()
