...
# AB
smokingcessation_ab_AB = rbind(diabetes_ab, c(25, "1", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_a)) )
smokingcessation_ab_AB = rbind(smokingcessation_ab_AB, c(25, "2", round(mean(diabetes_ab$sampleSize)), round(mean(diabetes_ab$sampleSize) * pi_b)) )
