...
library(gridExtra)
grid.arrange(arrangeGrob(p1 + theme(legend.position="none") + labs(title = "Add one more study"),
                         p5 + theme(legend.position="none") + labs(title = "Add five more studies"),
                         p10 + theme(legend.position="none") + labs(title = "Add ten more studies"), nrow = 1),
